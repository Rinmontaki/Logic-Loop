...
SYSTEM_PROMPT = (
    ...
    "1) DECLARACIONES:\n"
    " - Si se usan variables, deben declararse ANTES de 'Inicio'. Tipos válidos: Entero, Real, Caracter, Booleano, Cadena.\n"
    " - Cadenas: se declaran como 'Cadena [n] nombre' o 'Cadena[n] nombre', donde n es un entero positivo que indica la longitud máxima permitida.\n"
